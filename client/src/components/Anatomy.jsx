...
const Anatomy = ({ setSelectedPart }) => {
  return (
    /***************************************************************************************
     *    Title: Human Body SVG
     *    Author: Volkan Deveci
     *    Availability: https://codepen.io/volcanioo/pen/RLXOar
     ***************************************************************************************/

    <StyledAnatomy>
      <div class="human-body">
        <div className="head-wrapper" onClick={() => setSelectedPart("neck")}>
          <svg
            data-position="head"
            class="head"
        ...
        <div className="arm-wrapper" onClick={() => setSelectedPart("arms")}>
          <svg
            data-position="arm"
            class="arm"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          className="upper-body-wrapper"
          onClick={() => setSelectedPart("upperbody")}
        >
          <svg
            data-position="chest"
            class="chest"
        ...
        <div
          className="lower-body-wrapper"
          onClick={() => setSelectedPart("lowerbody")}
        >
          <svg
            data-position="legs"
            class="legs"
        ...
        <div className="hands-wrapper" onClick={() => setSelectedPart("wrist")}>
          <svg
            data-position="hands"
            class="hands"
            xmlns="http://www.w3.org/2000/svg"
...
const StyledAnatomy = styled.div`
  flex-basis: 60%;
  .human-body {
    width: 207px;
    position: relative;
  ...
  .human-body .upper-body-wrapper:hover svg path {
    fill: rgb(7, 20, 38);
    stroke: white;
    stroke-width: 0.5px;
  }
  ...
  // tooltips right
  .human-body .upper-body-wrapper:hover::after {
    content: "Upper Body";
    font-size: 1.2rem;
    position: absolute;
    margin-left: 180.5px;
  ...
  .human-body .head-wrapper:hover::after {
    content: "Neck";
    font-size: 1.2rem;
    position: absolute;
    margin-left: 180.5px;
  ...
  .human-body .hands-wrapper:hover::after {
    content: "Wrists";
    font-size: 1.2rem;
    position: absolute;
    margin-left: 220.5px;
  ...
  // tooltips left
  .human-body .lower-body-wrapper:hover::after {
    content: "Lower Body";
    font-size: 1.2rem;
    position: absolute;
    color: white;
  ...
  .human-body .arm-wrapper:hover::after {
    content: "Arms";
    font-size: 1.2rem;
    position: absolute;
    color: white;
  ...
  .human-body .shoulder-wrapper:hover::after {
    content: "Shoulders";
    font-size: 1.2rem;
    position: absolute;
    color: white;

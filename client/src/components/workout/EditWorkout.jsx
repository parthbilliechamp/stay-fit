...
export default function EditWorkout() {
  ...
  const [date, setDate] = useState(Object.keys(workoutData)[0]);
  const [workouts, setWorkouts] = useState(workoutData[date]);
  ...
  const handleDateChange = (event) => {
    ...
    setWorkouts(workoutData[selectedDate].workouts);
  };
